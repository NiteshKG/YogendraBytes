...
const About = () => {
  return (
    <div className="bg-blue-300 text-blue-900 py-16 px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
         <Link to="/learn"> <button className="bg-blue-500 text-white px-6 py-2 rounded-lg shadow hover:bg-blue-600 transition-all duration-300">
            Learn More
          </button></Link>
        </div>
      </div>
